...
const HEXAGON = `
  <svg viewBox="0 0 24 24">
    ...
    <polygon points="9.5,10.5 12,9 14.5,10.5 14.5,12.5 12,14 9.5,12.5" class="foliplus-heatmap-fill-center"/>
    <polygon points="9.5,10.5 12,9 14.5,10.5 14.5,12.5 12,14 9.5,12.5" stroke-width="1"/>
    <polygon points="9.5,5.5 12,4 14.5,5.5 14.5,7.5 12,9 9.5,7.5" class="foliplus-heatmap-fill-secondary"/>
    ...
    <polygon points="9.5,16.5 12,15 14.5,16.5 14.5,18.5 12,20 9.5,18.5" class="foliplus-heatmap-fill-secondary"/>
