...
export const registerInteractions = (ui: LayerUI): (() => void) => {
  ...
  return ensureInteraction(ui.m.map).register(CONF.name, [
    ...
    { key: "ArrowDown", container, handler: () => ui.handleKeyDown({ key: "ArrowDown", preventDefault: () => {} } as KeyboardEvent) },
    { key: "ArrowLeft", container, handler: () => ui.handleKeyDown({ key: "ArrowLeft", preventDefault: () => {} } as KeyboardEvent) },
    { key: "ArrowRight", container, handler: () => ui.handleKeyDown({ key: "ArrowRight", preventDefault: () => {} } as KeyboardEvent) },
    { key: " ", container, handler: () => ui.handleKeyDown({ key: " ", preventDefault: () => {} } as KeyboardEvent) },
