  ...
  const SVGs = {
    HEXAGON: `
      <svg viewBox="0 0 24 24">
        ...
        <polygon points="12,3 20.5,7.5 20.5,16.5 12,21 3.5,16.5 3.5,7.5" fill="currentColor" opacity="0.06" stroke="none"/>
        <polygon points="9.5,10.5 12,9 14.5,10.5 14.5,12.5 12,14 9.5,12.5" fill="currentColor" opacity="0.15" stroke="none"/>
        <polygon points="9.5,10.5 12,9 14.5,10.5 14.5,12.5 12,14 9.5,12.5" stroke-width="1"/>
        <polygon points="9.5,5.5 12,4 14.5,5.5 14.5,7.5 12,9 9.5,7.5" fill="currentColor" opacity="0.08" stroke="none"/>
        ...
        <polygon points="9.5,16.5 12,15 14.5,16.5 14.5,18.5 12,20 9.5,18.5" fill="currentColor" opacity="0.08" stroke="none"/>
