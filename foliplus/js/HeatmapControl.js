(function() {
  ...
  if (typeof h3 === 'undefined') {
    console.warn(`[HeatmapControl] ${_('heatmap.no_h3')}`);
    SM.showHint('heatmap', _('heatmap.no_h3'), 5000);
    return;
  }
  if (typeof ss === 'undefined') {
    console.warn(`[HeatmapControl] ${_('heatmap.no_ss')}`);
    SM.showHint('heatmap', _('heatmap.no_ss'), 5000);
    return;
  }
  ...
  // ==================== Core: Data Aggregation & Rendering Engine ====================
  ...
  class HeatmapControl extends L.Control {
    ...
    onAdd() {
      ...
      header.innerHTML = `
        ...
        <button class="close-btn" title="${_('layer.close_title')}">${SM.SVGs.CLOSE}</button>`;
