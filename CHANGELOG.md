...
- `LayerControl`: the attributes panel's timestamps now render in the configured locale, instead of always falling back to English ([#298](https://github.com/Zeroto521/foliplus/pull/298))
