...
- `MeasureControl`: area labels add a thousands separator (`1,234 m²`) via `common`'s `formatNumber` helper, keeping the digit grouping language-agnostic ([#249](https://github.com/Zeroto521/foliplus/pull/249))
