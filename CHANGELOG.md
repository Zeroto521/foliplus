...
- `Test`: drop the dead `foliplus/js/**/*.js` entry from the vitest coverage include — no `.js` source has existed since the TypeScript migration ([#304](https://github.com/Zeroto521/foliplus/pull/304))
