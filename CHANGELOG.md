...
- `LayerControl`: suppress flash on fold rebuild — remove rebuild-driven transitions (`background-color` on rows, `background-color` + `border-color` on checkbox) ([#232](https://github.com/Zeroto521/foliplus/pull/232))
