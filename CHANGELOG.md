...
- `MeasureControl`: export measurements to GeoJSON or CSV — selectable via the `export_format` parameter; the CSV carries a WKT column plus a UTF-8 BOM so Excel detects the encoding ([#168](https://github.com/Zeroto521/foliplus/pull/168), [#253](https://github.com/Zeroto521/foliplus/pull/253))
