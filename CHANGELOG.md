...
- `FullscreenControl`: `hide_selector` parameter to hide arbitrary page elements (navbar, footer, …) while in fullscreen, extending `hide_others` beyond `.leaflet-control-container`; original inline `display` values are restored on exit
