...
- `SearchControl`: clicking (or keyboard-selecting) a coordinate history entry restores the canonical query instead of its reverse-geocoded address, so the entry stays reusable in coordinate mode ([#218](https://github.com/Zeroto521/foliplus/pull/218))
