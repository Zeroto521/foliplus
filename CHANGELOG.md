...
- `LayerControl`: per-layer style panel from a layer's ⋮ menu — labels on each feature, with a label-field picker and a number-format picker (currently the only style dimension; others land under the same menu) ([#236](https://github.com/Zeroto521/foliplus/pull/236), [#331](https://github.com/Zeroto521/foliplus/pull/331))
