...
- `hint`: cap the toast at `min(480px, 80vw)` so a long locale string wraps instead of overflowing the map on a phone, with a wider cap under a 480px viewport ([#331](https://github.com/Zeroto521/foliplus/pull/331))
