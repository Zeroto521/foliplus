...
- `TypeScript`: no more `as any` / `@ts-ignore` in production sources — `map.foliplus` casts replaced by a single seed in `core/mapApi.ts`, `test/js` typed under its own strict program (1495 errors, measured, not CI-gated) ([#305](https://github.com/Zeroto521/foliplus/pull/305))
