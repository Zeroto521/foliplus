...
- Keyboard cursor + focus ring unified across foliplus — LayerControl/SearchControl cursor (left accent bar + glow, no wash), global `--focus-ring` soft double-ring on all `:focus-visible`, and removed red more-button tint on `.active` ([#229](https://github.com/Zeroto521/foliplus/pull/229))
