...
- `HeatmapControl`: initial layer scan is signal-driven — re-scans on `CONTROL_ATTACHED` (LayerControl ready) instead of up to 8 × 300ms retries; a single timeout settles the no-layer hint ([#285](https://github.com/Zeroto521/foliplus/pull/285))
