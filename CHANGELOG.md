...
- `FullscreenControl`: crossfade scrim on enter/exit — basemap fades to 50% dark, controls/hints/markers untouched. Container-mounted so it paints in native fullscreen; respects `prefers-reduced-motion`
