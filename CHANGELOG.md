...
- `LayerControl`: split `LayerUI` into `ui/*` modules (`list`/`state`/`keyboard`/`focus`/…) with a single `ui/index.js` export; public API unchanged; tests split to match (`ui/*.test.ts` + shared `fixture.ts`) ([#291](https://github.com/Zeroto521/foliplus/pull/291), [#296](https://github.com/Zeroto521/foliplus/pull/296), [#297](https://github.com/Zeroto521/foliplus/pull/297))
