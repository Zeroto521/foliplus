...
- `FullscreenControl`: add crossfade scrim on fullscreen toggle — visible exit fade via full-duration replay + deferred `startDimExit`, soft radial vignette gradient with frosted-glass depth ([#217](https://github.com/Zeroto521/foliplus/pull/217))
