...
- `MeasureControl`: labels are marked with `isLabel = true` BEFORE `addTo(mainLayer)`, ensuring correct routing to sub-layers ([#35](https://github.com/Zeroto521/foliplus/pull/35))
