...
- `LayerControl`: persist layer visibility state to localStorage — hidden layers stay hidden across page reloads, synced with the existing order + fold persistence
