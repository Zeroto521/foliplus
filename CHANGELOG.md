...
- `SearchControl`: coordinate history entries restore their canonical query (not the reverse-geocoded address) on click and keyboard selection, keeping them reusable in coordinate mode ([#218](https://github.com/Zeroto521/foliplus/pull/218))
