...
- `LayerControl`: mouse hover, Tab focus and the arrow-key cursor share one row highlight (white row, red top/bottom glow, drag handle, type icon black, more button red); Escape clears the cursor in place; while the ⋮ menu or a row panel (attributes / style) is open the overlay owns the pointer — sibling rows stay on their resting look when the cursor crosses them on its way to the dropdown, and the ⋮ dropdown anchors flush to its row ([#229](https://github.com/Zeroto521/foliplus/pull/229), [#269](https://github.com/Zeroto521/foliplus/pull/269), [#276](https://github.com/Zeroto521/foliplus/pull/276), [#277](https://github.com/Zeroto521/foliplus/pull/277), [#332](https://github.com/Zeroto521/foliplus/pull/332))
