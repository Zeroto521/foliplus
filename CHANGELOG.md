...
- `LayerControl`: mouse hover, Tab focus and the arrow-key cursor share one row highlight (white row, red top/bottom glow, drag handle, type icon black, more button red); Escape clears the cursor in place ([#229](https://github.com/Zeroto521/foliplus/pull/229), [#269](https://github.com/Zeroto521/foliplus/pull/269), [#276](https://github.com/Zeroto521/foliplus/pull/276), [#277](https://github.com/Zeroto521/foliplus/pull/277))
