...
- `LayerControl`: styled keyboard navigation cursor — accent left bar, 8 % wash, hairline separators, entrance animation, and accent-coloured type-icon/more-button on the focused row, replacing the browser default outline
