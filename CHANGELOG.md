...
- `LocaleConfig`: custom strings from `LocaleConfig.from_json()` now reach the JS `CONF`, which previously shipped only the built-in tables and silently dropped every custom translation ([#290](https://github.com/Zeroto521/foliplus/pull/290))
