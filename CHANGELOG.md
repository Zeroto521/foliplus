...
- `LayerControl`: rename a layer from its ⋮ menu — inline rename input inside the layer label (Enter commits, Escape cancels, blur commits), covers both data layers and the color basemap, custom names persisted per-map to localStorage ([#227](https://github.com/Zeroto521/foliplus/pull/227))
