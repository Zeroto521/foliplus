...
_JS_USED_KEYS = {
    ...
    # Annotation style panel (interpolated format keys are built in
    # renderStylePanel via `T(\`annotation_format_${f}\`)`).
    "LayerControl.style_layer",
    "LayerControl.style_layer_tooltip",
    "LayerControl.annotation_label",
    "LayerControl.annotation_label_tooltip",
    "LayerControl.annotation_field",
    "LayerControl.annotation_field_placeholder",
    "LayerControl.annotation_format",
    "LayerControl.annotation_format_auto",
    "LayerControl.annotation_format_int",
    "LayerControl.annotation_format_comma",
    "LayerControl.annotation_format_percent",
    "LayerControl.annotation_collision",
    "LayerControl.annotation_collision_hint",
    "LayerControl.annotation_no_data",
