 ...
 *  Auto-scans component imports for used exports (see gen-shared-registry.mjs). */
const generateSharedRegistry = () => {
  const genResult = spawnSync(process.execPath, [resolve(__dirname, "gen-shared-registry.mjs")], { stdio: "inherit" });
